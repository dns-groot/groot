...
namespace zone {
	...
	private:
		...
		zone::Graph::VertexDescriptor GetAncestor(zone::Graph::VertexDescriptor, const vector<NodeLabel>&, vector<VertexDescriptor>&, int&) const;
		zone::Graph::VertexDescriptor GetClosestEncloser(zone::Graph::VertexDescriptor, const vector<NodeLabel>&, int&) const;
