...
extern std::atomic<long> gECcount;
extern vector<NodeFunction> gNodeFunctions;
extern vector<PathFunction> gPathFunctions;
extern moodycamel::ConcurrentQueue<EC> gECQueue;
extern std::atomic<bool> gDoneECgeneration;
extern moodycamel::ConcurrentQueue<json> gJsonQueue;
